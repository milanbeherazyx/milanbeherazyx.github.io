...
- Source of truth: PRD_portfolio_website.md (requirements, binding) and content-pack/content_pack.md (all personal facts/copy; its ✅/⚠️/⛔ publish flags are binding; ⛔ items never appear in site code or public files, even though the pack file itself is committed — see the pack's own §12).
